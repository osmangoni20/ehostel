const SidebarData = [
  ...
  { name: "Cost Manage",  icon: "calculator-outline",
  subOptions:[
    {name:"Add New ",link:"add_new_cost"},
    {name:"List View",link:"cost_list"}
  ] },
  { name: "Meal Manage", icon: "fast-food-outline",
    subOptions:[
...
},
  {
    ...
    subOptions: [
      { name: "Student Admission", link: "/new_add" },
  ...
  { name: "Students Payment", icon: "logo-paypal",
  subOptions:[
  ...
  { name: "Bill Manage",  icon: "newspaper-outline",
  subOptions:[
    {name:"Add New ",link:"add_bill"},
    {name:"List View",link:"bill_list"}
  ] },
  { name: "Notice Board",  icon: "notifications-outline",
  subOptions:[
    {name:"Add Notice ",link:"add_notice"},
    {name:"Notice",link:"notice"}
  ] },
  { name: "New Admin",subOptions:false, link: "/add_admin", icon: "person-add-outline" },
];
